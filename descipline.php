...
<head>
    ...
    <link rel="stylesheet" href="descipline.css">
...
<body>
    ...
    <table border ="1" cellpadding="20" cellspacing="1" text-align="center" id="T">
        ...
        <form class="form"  action="descipline.php" method="post" id="F">
            <fieldset>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$connection) {
        ...
        if (isset($_POST["modifier"])) {
          ...
          $req1 = "UPDATE `adherent` SET iddecipline = '$id' WHERE id = '" . $_SESSION['user_id'] . "'";
