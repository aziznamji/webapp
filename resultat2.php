...
<head>
    ...
    <link rel="stylesheet" href="resultat2.css">
...
<body>
    ...
    <div class="page">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="#">   <pre>                 Résultat</pre></a></li>
            </ul>
        </div>
        </ul>
    ...
    <h4>Résultat :</h4>
        ...
        <tbody>
            ...
            $query = "SELECT * FROM `resultat` WHERE idEquipe = '$idequipe'";
            $result = $mysqli->query($query);

            // Requête pour récupérer les données de la table "match"
            $query = $query = "SELECT * FROM `resultat`";;
            $result = $mysqli->query($query);
          ...
          <script>
              // Récupérer la liste déroulante et les boutons
              ...
              confirmerButton.addEventListener("click", () => {
                  ...
                  alert(`Vous avez sélectionné la discipline : ${selectedDiscipline}`);
              });
      
              annulerButton.addEventListener("click", () => {
                  // Réinitialiser la sélection ou effectuer d'autres actions d'annulation si nécessaire
                  disciplineSelect.selectedIndex = 0; // Sélectionner la première option
              });
          </script>
          </div>
