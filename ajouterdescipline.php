    ...
    <div class="page">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="modifierdescipline.php"> <pre>                 modifier</pre> </a></li>
                <li><a href="modifierdescipline.php">   <pre>                 consulter</pre></a></li>
            </ul>
        </div>
        <form class="form" action="ajouterdescpline.php" method="post" id="ajout">
            <fieldset>
                <legend>Ajouter descipline</legend>
                <table>
                    <tr>
                        <td><label class="label">Id descipline :</label></td>
                        <td><input class="input" type="text" name="id" placeholder="Saisir l'id du descipline"></td>
                    </tr>
                    <tr>
                        <td><label class="label">Libelle :</label></td>
                        <td><input class="input" type="text" name="libelle" placeholder="Saisir le libelle"></td>
                    </tr>
                </table>
                <div class="boutons">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$connection) {
          ...
          if(empty($id) || empty($libelle)){
            ...
            $req = "INSERT INTO decipline VALUES ('$id','$libelle')";
            $res = mysqli_query($connection, $req);

            if ($res) {
                echo "<script>alert('discipline ajoutée avec succès!');</script>";
            } else {
                echo "<script>alert('erreur essayez encore une fois');</script>";
            }
        }
    }
    ?>
