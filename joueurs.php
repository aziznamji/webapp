...
<head>
    ...
    <title>Recherche d'équipe</title>
...
<body>
    <body style="    background-image: url(assets/back4.jpg);">
        ...
        <div class="page">
            <div class="tete">
                <h1>Consulter joueurs</h1>
            </div>
            <div class="menu">
                <ul> 
                  <li id="About Us"><a href="equipe.php">Gestion équipe </a></li>
                  <li id="About Us"><a class="act"  href="#">consulter joueurs</a></li>
                </ul>
            </div>
            <div class="consulter">
                <h2>Les joueurs</h2>
                <form action="joueurs.php" method="post">
                    <input type="text" id="id_equipe" class="search-input" placeholder="ID d'équipe" name="id">
                    <!-- Utiliser une icône de recherche de Font Awesome -->
                    <button type="submit" class="search-button" name="supprimer">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$connection) {
        ...
        $req="select id, nom, prenom, tel from adherent WHERE idequipe = '$id'";
        $res = mysqli_query($connection, $req);
      // Boucle pour afficher les données dans le tableau
       if ($res->num_rows > 0) {
          while ($row = $res->fetch_assoc()) {
             echo "<tr>";
             echo "<td style='text-align: center; color: black;'>" . $row["id"] . "</td>";
             echo "<td style='text-align: center; color: black;'>" . $row["nom"] . "</td>";
             echo "<td style='text-align: center; color: black;'>" . $row["prenom"] . "</td>";
             echo "<td style='text-align: center; color: black;'>" . $row["tel"] . "</td>";
             echo "</tr>";
         }
      } else {
